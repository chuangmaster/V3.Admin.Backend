...
VALUES 
    ('permissions.access', '權限管理頁面訪問', '允許訪問權限管理頁面', 'route', '/admin/permissions'),
    ('roles.access', '角色管理頁面訪問', '允許訪問角色管理頁面', 'route', '/admin/roles'),
    ('user_roles.access', '用戶角色管理頁面訪問', '允許訪問用戶角色指派頁面', 'route', '/admin/user-roles'),
    ('audit_logs.access', '稽核日誌頁面訪問', '允許訪問稽核日誌查詢頁面', 'route', '/admin/audit-logs')
ON CONFLICT (permission_code) DO NOTHING;
