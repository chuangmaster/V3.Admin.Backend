...
public class PermissionValidationIntegrationTests : IClassFixture<CustomWebApplicationFactory>, IAsyncLifetime
{
    ...
    public async Task GetUserEffectivePermissions_WithMultipleRoles_ReturnsUnionOfAllPermissions()
    {
        ...
        var apiResponse = JsonSerializer.Deserialize<ApiResponseModel<UserEffectivePermissionsDto>>(content, _jsonOptions);
        ...
        permissionCodes.Should().Contain("permission.validation.test2");
    }
